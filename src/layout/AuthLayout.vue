<template>
    <div class="main-content bg-pepsi-tertiary">
        <!-- Navbar -->
        ...
        <!-- Header -->
        <div class="header bg-gradient-pepsi-secondary py-4 py-lg-5">
            <div class="container">
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h1 class="text-white">Bienvenido</h1>
                            <p class="text-lead text-white">Inicia sesión para continuar.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center justify-content-xl-between">
                    ...
                    <div class="col-xl-6">
                        <ul class="nav nav-footer justify-content-center justify-content-xl-end">
                            ...
                            <li class="nav-item">
                                <a href="http://blog.creative-tim.com" class="nav-link text-white" target="_blank">Blog</a>
                            </li>
                            <li class="nav-item">
                                <a href="https://github.com/creativetimofficial/argon-dashboard/blob/master/LICENSE.md"
                                   class="nav-link  text-white" target="_blank">MIT License</a>
                            </li>
                        </ul>
                    </div>
                </div>
